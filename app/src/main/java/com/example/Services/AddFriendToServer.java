...
public class AddFriendToServer {
    private String url= IPUtil.IP+IPUtil.PORT+"/MyServlet/addFriends";
    private Handler handler;
    public static final int SEND_SUCCESS=0x123;
    public static final int SEND_FAIL=0x124;
    public AddFriendToServer(Handler handler){

        this.handler=handler;
    }

    public void addFriendToServer(String userName,String FriendName){
