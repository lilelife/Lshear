...
import com.example.lshare.locshearActivity;
...
public class WeixinChatDemoActivity extends Activity implements View.OnClickListener {
	...
	private Button mBtnLshear;//查看位置
	...
	public void initView() {
		...
		userName_now=intent.getStringExtra("username_now");
		mListView = (ListView) findViewById(R.id.listview);
		mBtnSend = (Button) findViewById(R.id.btn_send);
		mBtnSend.setOnClickListener(this);
		mBtnBack = (Button) findViewById(R.id.btn_back);
		mBtnBack.setOnClickListener(this);
		mBtnLshear=(Button)findViewById(R.id.lshear);
		mBtnLshear.setOnClickListener(this);

		mEditTextContent = (EditText) findViewById(R.id.et_sendmessage);
		chatName=(TextView)findViewById(R.id.chatName);
		chatName.setText(chatname);
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.lshear:
				//TODO 跳转到地图位置共享
				Intent intent=new Intent(WeixinChatDemoActivity.this, locshearActivity.class);
				intent.putExtra("name",userName_now);

				intent.putExtra("friendName",chatname);
